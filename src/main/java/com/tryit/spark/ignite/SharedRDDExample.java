package com.tryit.spark.ignite;
 ...
 *
 * Created by agebriel on 7/12/17.
 */
public class SharedRDDExample
{
	private final static String CONFIG_FILE = "/Users/agebriel/fox/foxsvcs/tryit/src/main/java/com/tryit/spark/ignite/example-shared-rdd.xml";
	/**
	...
	public static void main(String args[]) {
		...
		JavaIgniteContext<Integer, Integer> igniteContext = new JavaIgniteContext<Integer, Integer>(
			sparkContext,CONFIG_FILE, false);
